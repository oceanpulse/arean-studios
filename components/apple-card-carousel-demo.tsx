...
export default function AppleCardsCarouselDemo() {
  ...
  return (
    <div className="w-full h-full py-20">
      ...
      A Beginner-Friendly Guide to Ethereum Tokens
      </h2>
...
// The original data is now imported from carouselData.tsx, but we keep the DummyContent 
// component here to maintain the exact same structure