...
export const FloatingNav = ({
  ...
  // Start with visible set to true so navbar is visible at page load
  ...
  useMotionValueEvent(scrollYProgress, "change", (current) => {
    ...
    if (typeof current === "number") {
      ...
      // At top of page, always show the navbar
      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-600 items-center flex space-x-1 text-neutral-50 dark:hover:text-neutral-500 hover:text-neutral-300"
            )}
          >
